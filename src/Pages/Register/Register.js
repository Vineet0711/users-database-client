...
import { registerFunction } from '../../Sevices/Apis.js';
import { addData } from '../../component/context/ContextProvider.js';
...
const Register = () => {
 ...
 const submitUserData= async (e)=>{
  ...
  if(fName===""){
    ...
    if(response.status===200){setInputData({
      ...inputData,
      fName:"",
      lName:"",
      email:"",
  ...
  return (
    ...
    <Card className='shadow mt-3 p-3'>
      <div className='profile_div text-center'>
          <img src={preview?preview:"images/man.png"} alt='image'></img>
      </div>
